...
import '../parent_screens/add_task_screen.dart';
                    ...
                    children: [
                      ...
                      data.box.get('role') == 'parent' && snapshot.data?.docs[index].get('status') == 'paid'
                          ...
                          ? Padding(
                              ...
                              child: Row(
                          children: [
                                Expanded(child: Text('Вы можете редактировать задачу, пока она находится в процессе обсуждения цены и не подтверждена ребенком', style: kTextStyleWhite,)),
                                IconButton(
                                  onPressed: () {
    ...
    return Padding(
      ...
      child: data.box.get('role') == 'child'
        ...
        children: [
          ...
          const SizedBox(height: 8,),
          Text('Если задание оплачено, завершите его', style: kTextStyleOrange,),
          const SizedBox(height: 8,),
          ChangeButtonWidget(
            index: index,
            snapshot: snapshot,
